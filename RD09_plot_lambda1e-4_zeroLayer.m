...
%******************************
pixelPressureMatrix = importdata(['./results_with_zero_layer/adjoint/AFB/pixelPressure_FISTA_tau', FISTA.tau, '_lambda', FISTA.lambda, '_iter', FISTA.iter, '.dat'], ' ', 0);
pixelPressure = max(0, matrix2cube(pixelPressureMatrix, Nz));
plot_projection(pixelPressure, dx);
a = axes;
...
%******************************
pixelPressureMatrix = importdata(['./results_with_zero_layer/adjoint/S-PDHG/pixelPressure_S-PDHG_sigma', SPDHG.sigma, '_tau', SPDHG.tau, '_theta', SPDHG.theta, '_lambda', SPDHG.lambda, '_batch', SPDHG.batch, '_subepoch', SPDHG.epoch, '.dat'], ' ', 0);
pixelPressure = max(0, matrix2cube(pixelPressureMatrix, Nz));
plot_projection(pixelPressure, dx);
a = axes;
...
for ii = 1:L
    ...
    for iter = 1:GD.nIter{ii}
        ...
        % Dual error
        tSignal = importdata(['./results_with_zero_layer/forward/FB/forwardSignal_GD_tau', GD.tau{ii}, '_lambda', GD.lambda, '_iter', int2str(iter), '.dat'], ' ', 0);
        yi = tSignal(2:end, :);
...
ax.GridAlpha = 0.2;
axis([0 30 3 6])
legend('GD 8e17', 'GD 1.6e18');
save ./results_with_zero_layer/error_vectors/GD_error_dd_lambda1em4 GD_error_dd GD;
 
%======================================================================
% Stochastic Gradient descent
%======================================================================
disp('S-GD');
SGD.tau = {'1.6e18', '3.2e18'};
SGD.nIter = {30, 30};
SGD.lambda = '1e-4';
SGD.batch = '100';
L = length(SGD.tau);
...
for ii = 1:L
    ...
    for iter = 1:SGD.nIter{ii}
        disp(['iter ', int2str(iter)])
        % Dual error
        tSignal = importdata(['./results_with_zero_layer/forward/S-FB/forwardSignal_S-GD_tau', SGD.tau{ii}, '_lambda', SGD.lambda, '_batch', SGD.batch, '_subepoch', int2str(iter), '.dat'], ' ', 0);
        yi = tSignal(2:end, :);
...
ax = gca;
ax.GridAlpha = 0.2;
legend('SGD 1.6e18', 'SGD 3.2e18');
save ./results_with_zero_layer/error_vectors/SGD_error_dd_lambda1em4 SGD_error_dd SGD;
...
ax = gca;
ax.GridAlpha = 0.2;
legend('FISTA 4e17', 'FISTA 8e17');
save ./results_with_zero_layer/error_vectors/FISTA_error_dd_lambda1em4 FISTA_error_dd FISTA;

%======================================================================
% PDHG
%======================================================================
disp('PDHG');
PDHG.tau = {'8e17', '1.6e18'};
PDHG.nIter = {30, 30};
PDHG.sigma = '1';
PDHG.theta = '1';
PDHG.lambda = '1e-4';
...
ax = gca;
ax.GridAlpha = 0.2;
legend('PDHG 8e17', 'PDHG 1.6e18');
save ./results_with_zero_layer/error_vectors/PDHG_error_dd_lambda1em4 PDHG_error_dd PDHG;
...
for ii = 1:L
    ...
    for iter = 1:SPDHG.nIter{ii}
        disp(['iter ', int2str(iter)])
        % Dual
        tSignal = importdata(['./results_with_zero_layer/forward/S-PDHG/forwardSignal_S-PDHG_sigma', SPDHG.sigma, '_tau', SPDHG.tau{ii}, '_theta', SPDHG.theta, '_lambda', SPDHG.lambda, '_batch', SPDHG.batch, '_subepoch', int2str(iter), '.dat'], ' ', 0);
        yi = tSignal(2:end, :);
...
ax.GridAlpha = 0.2;
axis([0 30 3 6]);
legend('SPDHG 5e16', 'SPDHG 1e17');
save ./results_with_zero_layer/error_vectors/SPDHG_error_dd_lambda1em4 SPDHG_error_dd SPDHG;

%======================================================================
% PLOT ALL DUAL
%======================================================================
load ./results_with_zero_layer/error_vectors/GD_error_dd_lambda1em4;
load ./results_with_zero_layer/error_vectors/SGD_error_dd_lambda1em4;
load ./results_with_zero_layer/error_vectors/FISTA_error_dd_lambda1em4;
load ./results_with_zero_layer/error_vectors/PDHG_error_dd_lambda1em4;
load ./results_with_zero_layer/error_vectors/SPDHG_error_dd_lambda1em4;
