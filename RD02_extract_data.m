%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Main processing template script for experimental data
%
% Copyright (C) 2015 Felix Lucka
 
 
clear all; close all; clc
dataPath = '/cs/research/medim/projects2/projects/frullan/Documents/HighFreqCode/ExperimentalData/RD02_finger14/input_data/';
cd dataPath;
addpath(dataPath);
...
processPara.dataSet = '16BeamScan';
...
dataRep.ID = '16BeamScan';
dataRep.IDshort = '16BS_1';
 
setting.soundSpeed = 1580;
setting.type = 'static';
...
% path to SGL file, relative to dataPath
dataRep.data{1} = 'RD02_finger14.sgl';
...
preProcPara.tauStart            = -15; %-15 or 10?
preProcPara.tauInc              = 1;
%preProcPara.deleteChannelFL    = false;
 
processPara.upscalingMethod = 'freeInnerEven';
 
% identifier for the spatial properties of the reconstruction setting
%settingAlias = 'Up1Iso44x144x132';
settingAlias = 'Up2Iso80x120x120';
switch settingAlias
    case  'Up1Iso44x144x132'
        preProcPara.cutSizeFL        = true;
        preProcPara.cutSizePara.size = [144,132];
        preProcPara.tauEnd           = 471;
        processPara.depthResolution  = 'isotropic';
        processPara.upscalingFac     = 1;
        processPara.Nx               = 44;
        PML                          = [10,8,14];
    case  'Up2Iso80x120x120'
        preProcPara.cutSizeFL        = true;
        preProcPara.cutSizePara.size = [120,120];
        preProcPara.tauEnd           = 471;
        processPara.depthResolution  = 'isotropic';
            ...
            case '.mat'
                switch setting.type
                    ...
                    case 'dynamic'
                        ...
                        setting.sensor.dataID = dataRep.IDshort;
...
%% load and process a single frame of data
...
%resultsDir = makeDir([dataPath dataRep.ID]);
resultsDir = makeDir([dataPath]);
...
[sensor_data ,preProc] = getData(dataRep,setting,preProc,getPara);
save sensor_data_14400 sensor_data;
