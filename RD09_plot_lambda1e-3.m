...
ax.GridAlpha = 0.2;
axis([0 30 3 6])
legend('GD 8e17', 'GD 1.6e18', 'GD 3.2e18');
save ./results/error_vectors/GD_error_dd_lambda1em3 GD_error_dd GD;
 
%======================================================================
% Stochastic Gradient descent
%======================================================================
disp('S-GD');
SGD.tau = {'1.6e18', '3.2e18', '6.4e18'};
SGD.nIter = {30, 30, 30};
SGD.lambda = '1e-3';
SGD.batch = '100';
L = length(SGD.tau);
...
ax = gca;
ax.GridAlpha = 0.2;
legend('SGD 1.6e18', 'SGD 3.2e18', 'SGD 6.4e18');
save ./results/error_vectors/SGD_error_dd_lambda1em3 SGD_error_dd SGD;

%==============================
% FISTA
%==============================
disp('FISTA');
FISTA.tau = {'2e17', '4e17', '8e17'};
...
ax = gca;
ax.GridAlpha = 0.2;
legend('FISTA 2e17', 'FISTA 4e17', 'FISTA 8e17');
save ./results/error_vectors/FISTA_error_dd_lambda1em3 FISTA_error_dd FISTA;

%======================================================================
% PDHG
%======================================================================
disp('PDHG');
PDHG.tau = {'8e17', '1.6e18', '3.2e18'};
PDHG.nIter = {30, 30, 30};
PDHG.sigma = '1';
PDHG.theta = '1';
PDHG.lambda = '1e-3';
...
ax = gca;
ax.GridAlpha = 0.2;
legend('PDHG 8e17', 'PDHG 1.6e18', 'PDHG 3.2e18');
save ./results/error_vectors/PDHG_error_dd_lambda1em3 PDHG_error_dd PDHG;
...
save ./results/error_vectors/SPDHG_error_dd_lambda1em3 SPDHG_error_dd SPDHG;

%======================================================================
% PLOT ALL DUAL
%======================================================================
load ./results/error_vectors/GD_error_dd_lambda1em3;
load ./results/error_vectors/SGD_error_dd_lambda1em3;
load ./results/error_vectors/FISTA_error_dd_lambda1em3;
load ./results/error_vectors/PDHG_error_dd_lambda1em3;
load ./results/error_vectors/SPDHG_error_dd_lambda1em3;
...
ax.GridAlpha = 0.2;
axis([0 30 3 6]);
saveas(gcf, ['./figures/RD09_dualError_lambda1e-3.fig']);
...
ax.GridAlpha = 0.2;
axis([1 30 1e-4 1e-1]);
saveas(gcf, ['./figures/RD09_relativeDualError_lambda1e-3.fig']);
