...
%==================================================
% RT
filenameData = './input_data/pixelPressure_adjoint_19152sensors.dat';
...
% KWave
filenameData = './input_data/pressure_adjoint_kWave_19152sensors.dat';
pixelPressureMatrix = importdata(filenameData, ' ', 0);
pixelPressure = max(0, matrix2cube(pixelPressureMatrix, Nz));
plot_projection(pixelPressure, dx);
...
t.Visible = 'on'; 
saveas(gcf, ['./figures/RD06_GD_tau', GD.tau, '_lambda', GD.lambda, '_iter', GD.iter, '.fig']);
saveas(gcf, ['./figures/RD06_GD_tau', GD.tau, '_lambda', GD.lambda, '_iter', GD.iter], 'epsc');
...
t.Visible = 'on'; 
%caxis([0, 0.75])
saveas(gcf, ['./figures/RD06_S-GD_norm_tau', SGD.tau, '_lambda', SGD.lambda, '_batch', SGD.batch, '_epoch', SGD.epoch, '.fig']);
...
t.Visible = 'on'; 
saveas(gcf, ['./figures/RD06_FISTA_tau', FISTA.tau, '_lambda', FISTA.lambda, '_iter', FISTA.iter, '.fig']);
saveas(gcf, ['./figures/RD06_FISTA_tau', FISTA.tau, '_lambda', FISTA.lambda, '_iter', FISTA.iter], 'epsc');
...
t.Visible = 'on'; 
saveas(gcf, ['./figures/RD06_PDHG_sigma', PDHG.sigma, '_tau', PDHG.tau, '_lambda', PDHG.lambda, '_iter', PDHG.iter, '.fig']);
saveas(gcf, ['./figures/RD06_PDHG_sigma', PDHG.sigma, '_tau', PDHG.tau, '_lambda', PDHG.lambda, '_iter', PDHG.iter], 'epsc');
...
a.Visible = 'off'; 
t.Visible = 'on'; 
saveas(gcf, ['./figures/RD06_S-PDHG_sigma', SPDHG.sigma, '_tau', SPDHG.tau, '_lambda', SPDHG.lambda, '_batch', SPDHG.batch, '_epoch', SPDHG.epoch, '.fig']);
...
axis([0 8 3.6e-17 5e-17])
grid on;
box on;
ax = gca;
ax.GridAlpha = 0.2;
saveas(gcf, ['./figures/RD06_dd_error.fig']);
saveas(gcf, ['./figures/RD06_dd_error'], 'epsc');
