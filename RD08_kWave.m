...
% Reshape sensor data
sensor_data = reshape(sensor_data, [Ny/2*Nz/2, Nt]);
save input_data/sensor_data_14400.mat sensor_data;
...
% Save and run
kspaceFirstOrder3D(kgrid, medium, source_adj, sensor_adj, input_args{:}, 'SaveToDisk', 'input_data/RD08_adjoint_input_14400sensors.h5');
system('../kspaceFirstOrder3D-CUDA -i input_data/RD08_adjoint_input_14400sensors.h5 -o output_data/RD08_adjoint_output_14400sensors.h5 --p_final');

%==============================
% FORWARD
%==============================
PML_size = 10;
p0_adj_PML = h5read('output_data/RD08_adjoint_output_14400sensors.h5', '/p_final');
...
filename = 'input_data/RD08_forward_input_14400sensors.h5';
kspaceFirstOrder3D(kgrid, medium, source, sensor, input_args{:}, 'SaveToDisk', filename);
% Run forward
system('../kspaceFirstOrder3D-CUDA -i input_data/RD08_forward_input_14400sensors.h5 -o output_data/RD08_forward_output_14400sensors.h5');


%=========================================================================
% SENSOR DATA
%=========================================================================
sensor_data_forward_19152 = h5read('output_data/RD08_forward_output_14400sensors.h5', '/p');
