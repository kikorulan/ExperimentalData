...
% Save and run
kspaceFirstOrder3D(kgrid, medium, source_adj, sensor_adj, input_args{:}, 'SaveToDisk', 'input_data/RD09_adjoint_input_14400sensors.h5');
system('../kspaceFirstOrder3D-CUDA -i input_data/RD09_adjoint_input_14400sensors.h5 -o output_data/RD09_adjoint_output_14400sensors.h5 --p_final');
...
save input_data/kgrid_data_14400sensors.mat kgrid medium source sensor input_args;
filename = './input_data/RD09_forward_input_14400sensors.h5';
kspaceFirstOrder3D(kgrid, medium, source, sensor, input_args{:}, 'SaveToDisk', filename);
% Run forward
system('../kspaceFirstOrder3D-CUDA -i input_data/RD09_forward_input_14400sensors.h5 -o output_data/RD09_forward_output_14400sensors.h5');


%=========================================================================
% SENSOR DATA
%=========================================================================
sensor_data_forward_14400 = h5read('./output_data/RD09_forward_output_14400sensors.h5', '/p');
